...
# add the right path to the saved trained model to be loaded
...
print('True Negative percentage: ', tn/(fp + fn + tp + tn))
print('False Positive percentage: ', fp/(fp + fn + tp + tn))
print('False Negative percentage: ', fn/(fp + fn + tp + tn))
print('True Positive percentage: ', tp/(fp + fn + tp + tn))
